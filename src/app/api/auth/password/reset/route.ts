...
function getMessages(
  ...
  return locale === "en"
    ? {
        ...
        internalError:
          "The password could not be reset at this time.",
      }
    : {
        forbiddenOrigin:
...
export async function POST(
  ...
  let input:
    ReturnType<
      typeof validatePasswordChangeRequest
    >;
